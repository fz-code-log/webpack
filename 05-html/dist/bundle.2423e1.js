...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.scss */ \"./05-html/style.scss\");\n/* harmony import */ var _sub__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sub */ \"./05-html/sub.js\");\n\n\nconsole.log('subFn--------', (0,_sub__WEBPACK_IMPORTED_MODULE_1__.subFn)(1, 9));\n\nconst alertMsg = msg => {\n  console.log(`msg:${msg}`);\n};\n\nconst testObj = {\n  a: {\n    b: {\n      c: 1\n    }\n  }\n};\n\nconst delayFn = () => {\n  return new Promise(resolve => {\n    setTimeout(() => {\n      resolve('延迟输出结果');\n    }, 3000);\n  });\n};\n\n(async () => {\n  const delayRes = await delayFn();\n  console.log('delayRes', delayRes);\n})();\n\ntry {\n  const attr = testObj?.b?.n || 'xx';\n  console.log(attr, 'attr');\n} catch (error) {\n  console.error('error-----', error);\n}\n\nalertMsg('输出信息');\n\n//# sourceURL=webpack://webpack/./05-html/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"subFn\": () => (/* binding */ subFn)\n/* harmony export */ });\nconst subFn = (a, b) => {\n  const res = a + b;\n  return res;\n};\n\n//# sourceURL=webpack://webpack/./05-html/sub.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./05-html/index.js");
/******/ 	
/******/ })()
;